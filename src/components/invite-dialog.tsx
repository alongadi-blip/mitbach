        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {invite
              ...
              : groupId
                ? 'המוזמן יצטרף ישר לקבוצה ויראה את כל מה ששותף בה. גם למי שכבר יש חשבון — פתיחת הקישור תצרף אותו.'
                : 'הזמנה זו פותחת חשבון בלבד, בלי שיוך לקבוצה, והמוזמן יראה מסך ריק עד שיצורף לאחת. כדי לצרף לקבוצה, השתמשו בכפתור ההזמנה שבתוך הקבוצה עצמה.'}
          </DialogDescription>
        </DialogHeader>
